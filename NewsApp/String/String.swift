...
extension String {
    ...
    func getSlotTime() -> String{
        ...
        dateFormatter.locale = Locale.init(identifier: LocalizationSystem.sharedInstance.getLanguage())
    ...
    func formatDayWithoutYear() -> String {
        let dateFormatter = DateFormatter()
